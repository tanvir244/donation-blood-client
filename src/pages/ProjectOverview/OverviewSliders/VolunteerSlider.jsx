...
export default function VolunteerSlider() {
    ...
    const volunteerData = [
        {
            image: "https://i.ibb.co.com/WGXjRyF/2-2.jpg"
        },
        {
            image: "https://i.ibb.co.com/WtPsWWx/2-3.png"
        },
        {
            image: "https://i.ibb.co.com/yYQfjbj/2-4.png"
        }
    ];
    ...
    return (
        <>
            ...
            >
                <div>
                    {
                        volunteerData.map(data => (<SwiperSlide
                            key={data.image}
                        >
