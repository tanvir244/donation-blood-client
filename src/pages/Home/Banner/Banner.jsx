            ...
            >
                <SwiperSlide>
                    <div style={{
                        ...
                        <div className='w-[90%] md:w-[70%] lg:w-[40%] mx-auto text-center pt-28'>
                            <h1 className='text-[#ff0000] font-bold text-5xl md:text-6xl mb-6'>Be a Lifesaver, Give Blood</h1>
                ...
                <SwiperSlide>
                    <div style={{
                        ...
                        <div className='w-[90%] md:w-[70%] lg:w-[40%] mx-auto text-center pt-28'>
                            <h1 className='text-[#ff0000] font-bold text-5xl md:text-6xl mb-6'>Save Lives, Donate Blood</h1>
                            <div className='text-white'>
                ...
                <SwiperSlide>
                    <div style={{
                        ...
                        <div className='w-[90%] md:w-[70%] lg:w-[40%] mx-auto text-center pt-28'>
                            <h1 className='text-[#ff0000] font-bold text-5xl md:text-6xl mb-6'>Give the Gift of Life</h1>
                            <div className='text-white'>
